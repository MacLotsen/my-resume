...
% Temporary work around for broken pdfx issue, thanks to David Carlisle:
%   https://tex.stackexchange.com/a/720984/314265
\let\foo\currentgrouplevel
\chardef\currentgrouplevel0
\usepackage[a-1b]{pdfx}
\let\currentgrouplevel\foo
